...
OUT_DIR = "./results_sec_62"
JOB_SCRIPT_DIR = "./temp_job_scripts_sec62"
SLURM_LOG_DIR = "./slurm_logs_sec62"
...
config = {
    ...
    "seeds": list(range(1, 11)) # 10 independent replications per n
}
...
def main():
    ...
    print(f"Generating and submitting {len(experiments)} Policy Optimization jobs...")
    
    for run_idx, exp in enumerate(experiments, start=1):
        n, seed = exp["sample_sizes"], exp["seeds"]
        
        python_run_command = (
            f"python exp_sec_62.py "
